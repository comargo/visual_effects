...
#ifndef GRADIENT_PALETTES_H_
#define GRADIENT_PALETTES_H_
...
DECLARE_GRADIENT_PALETTE( bhw1_28_gp );
...
static const uint8_t gGradientPaletteCount = sizeof(gGradientPalettes) / sizeof(uint32_t*);

#endif /* GRADIENT_PALETTES_H_ */
